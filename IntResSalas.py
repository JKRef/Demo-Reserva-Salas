...
class Ui_HotelSistemaReservas(object):
    ...
    def retranslateUi(self, HotelSistemaReservas):
        ...
        HotelSistemaReservas.setWindowTitle(_translate("HotelSistemaReservas", "Reserva Tu Sala"))
        self.lbl_fecha_reserva.setText(_translate("HotelSistemaReservas", "Fecha de reserva:"))
        self.lbl_cantidad_dias.setText(_translate("HotelSistemaReservas", "Cantidad de horas:"))
        self.lbl_tipo_habitacion.setText(_translate("HotelSistemaReservas", "Tipo Sala:"))
        self.cbx_tipo_habitacion.setItemText(0, _translate("HotelSistemaReservas", "Reunion chica"))
        self.cbx_tipo_habitacion.setItemText(1, _translate("HotelSistemaReservas", "Reunion grande"))
        self.cbx_tipo_habitacion.setItemText(2, _translate("HotelSistemaReservas", "Multimedia"))
        self.cbx_tipo_habitacion.setItemText(3, _translate("HotelSistemaReservas", "Evento"))
        self.btn_calcular.setText(_translate("HotelSistemaReservas", "Reservar"))
        self.lbl_resumen_seleccion.setText(_translate("HotelSistemaReservas", "Resumen:"))
        self.lbl_costo.setText(_translate("HotelSistemaReservas", "Capacidad:"))